...
5. **Lanes + Mobile** - randomly balance all bowlers across available lanes, publish lane-specific mobile scoring pages, generate QR-coded paper score sheets, and sync phone-entered qualifying scores back to the Tournament Manager database.
...
The PDF has one page per lane, names pre-filled down the left, six game columns, a total column, and a QR code that opens that lane's mobile scoring page.
